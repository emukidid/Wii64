...
static char FRAME_STRINGS[39][23] =
	{ "General",
	  "Video",
	  "Input",
	  "Audio",
	...
	//Strings for Input tab [23]
	  ...
	  "Auto Load Slot:",
	  "Default",
	//Strings for Audio tab [29]
	  "Disable Audio",
	  "Yes",
	  "No",
	//Strings for Saves tab [32]
...
{ //	button	buttonStyle buttonString		x		y		width	height	Up	Dwn	Lft	Rt	clickFunc				returnFunc
	...
	{	NULL,	BTN_A_SEL,	FRAME_STRINGS[36],	295.0,	310.0,	 55.0,	56.0,	9,	14,	13,	12,	Func_ClockDivider1,		Func_ReturnFromSettingsFrame }, // CPU Clock Divider: 1
	{	NULL,	BTN_A_SEL,	FRAME_STRINGS[37],	360.0,	310.0,	 55.0,	56.0,	9,	15,	11,	13,	Func_ClockDivider2,		Func_ReturnFromSettingsFrame }, // CPU Clock Divider: 2
	{	NULL,	BTN_A_SEL,	FRAME_STRINGS[38],	425.0,	310.0,	 55.0,	56.0,	9,	15,	12,	11,	Func_ClockDivider3,		Func_ReturnFromSettingsFrame }, // CPU Clock Divider: 3
	...
	{	NULL,	BTN_A_SEL,	FRAME_STRINGS[18],	325.0,	100.0,	 75.0,	56.0,	 1,	19,	17,	17,	Func_ShowFpsOn,			Func_ReturnFromSettingsFrame }, // Show FPS: On
	{	NULL,	BTN_A_SEL,	FRAME_STRINGS[19],	420.0,	100.0,	 75.0,	56.0,	 1,	20,	16,	16,	Func_ShowFpsOff,		Func_ReturnFromSettingsFrame }, // Show FPS: Off
	{	NULL,	BTN_A_SEL,	FRAME_STRINGS[20],	230.0,	170.0,	 75.0,	56.0,	16,	21,	20,	19,	Func_ScreenMode4_3,		Func_ReturnFromSettingsFrame }, // ScreenMode: 4:3
	{	NULL,	BTN_A_SEL,	FRAME_STRINGS[21],	325.0,	170.0,	 75.0,	56.0,	16,	21,	18,	20,	Func_ScreenMode16_9,	Func_ReturnFromSettingsFrame }, // ScreenMode: 16:9
	{	NULL,	BTN_A_SEL,	FRAME_STRINGS[22],	420.0,	170.0,	155.0,	56.0,	17,	22,	19,	18,	Func_ScreenForce16_9,	Func_ReturnFromSettingsFrame }, // ScreenMode: Force 16:9 in-game
	{	NULL,	BTN_A_SEL,	FRAME_STRINGS[18],	325.0,	240.0,	 75.0,	56.0,	19,	23,	22,	22,	Func_CpuFramebufferOn,	Func_ReturnFromSettingsFrame }, // CPU FB: On
	{	NULL,	BTN_A_SEL,	FRAME_STRINGS[19],	420.0,	240.0,	 75.0,	56.0,	20,	24,	21,	21,	Func_CpuFramebufferOff,	Func_ReturnFromSettingsFrame }, // CPU FB: Off
	{	NULL,	BTN_A_SEL,	FRAME_STRINGS[18],	325.0,	310.0,	 75.0,	56.0,	21,	25,	24,	24,	Func_2xSaiTexturesOn,	Func_ReturnFromSettingsFrame }, // 2xSai: On
	{	NULL,	BTN_A_SEL,	FRAME_STRINGS[19],	420.0,	310.0,	 75.0,	56.0,	22,	26,	23,	23,	Func_2xSaiTexturesOff,	Func_ReturnFromSettingsFrame }, // 2xSai: Off
	{	NULL,	BTN_A_SEL,	FRAME_STRINGS[18],	325.0,	380.0,	 75.0,	56.0,	23,	 1,	26,	26,	Func_FbTexturesOn,		Func_ReturnFromSettingsFrame }, // FbTex: On
	{	NULL,	BTN_A_SEL,	FRAME_STRINGS[19],	420.0,	380.0,	 75.0,	56.0,	24,	 1,	25,	25,	Func_FbTexturesOff,		Func_ReturnFromSettingsFrame }, // FbTex: Off
	//Buttons for Input Tab (starts at button[27])
	{	NULL,	BTN_A_NRM,	FRAME_STRINGS[23],	180.0,	100.0,	280.0,	56.0,	 2,	28,	-1,	-1,	Func_ConfigureInput,	Func_ReturnFromSettingsFrame }, // Configure Mappings
	{	NULL,	BTN_A_NRM,	FRAME_STRINGS[24],	180.0,	170.0,	280.0,	56.0,	27,	29,	-1,	-1,	Func_ConfigurePaks,		Func_ReturnFromSettingsFrame }, // Configure Paks
	{	NULL,	BTN_A_NRM,	FRAME_STRINGS[25],	180.0,	240.0,	280.0,	56.0,	28,	30,	-1,	-1,	Func_ConfigureButtons,	Func_ReturnFromSettingsFrame }, // Configure Buttons
	...
	{	NULL,	BTN_A_NRM,	FRAME_STRINGS[28],	295.0,	380.0,	135.0,	56.0,	30,	 2,	-1,	-1,	Func_ToggleButtonLoad,	Func_ReturnFromSettingsFrame }, // Toggle Button Load Slot
	//Buttons for Audio Tab (starts at button[33])
	{	NULL,	BTN_A_SEL,	FRAME_STRINGS[30],	345.0,	100.0,	 75.0,	56.0,	 3,	 3,	34,	34,	Func_DisableAudioYes,	Func_ReturnFromSettingsFrame }, // Disable Audio: Yes
	{	NULL,	BTN_A_SEL,	FRAME_STRINGS[31],	440.0,	100.0,	 75.0,	56.0,	 3,	 3,	33,	33,	Func_DisableAudioNo,	Func_ReturnFromSettingsFrame }, // Disable Audio: No
	//Buttons for Saves Tab (starts at button[35])
	{	NULL,	BTN_A_SEL,	FRAME_STRINGS[30],	375.0,	100.0,	 75.0,	56.0,	 4,	37,	36,	36,	Func_AutoSaveNativeYes,	Func_ReturnFromSettingsFrame }, // Auto Save Native: Yes
	{	NULL,	BTN_A_SEL,	FRAME_STRINGS[31],	470.0,	100.0,	 75.0,	56.0,	 4,	37,	35,	35,	Func_AutoSaveNativeNo,	Func_ReturnFromSettingsFrame }, // Auto Save Native: No
	{	NULL,	BTN_A_NRM,	FRAME_STRINGS[33],	365.0,	170.0,	190.0,	56.0,	35,	38,	-1,	-1,	Func_CopySaves,			Func_ReturnFromSettingsFrame }, // Copy Saves
	{	NULL,	BTN_A_NRM,	FRAME_STRINGS[34],	365.0,	240.0,	190.0,	56.0,	37,	 4,	-1,	-1,	Func_DeleteSaves,		Func_ReturnFromSettingsFrame }, // Delete Saves
};
...
{ //	textBox	textBoxString		x		y		scale	centered
	...
	{	NULL,	FRAME_STRINGS[35],	155.0,	338.0,	 1.0,	true }, // CPU Clock Divider: 1/2/3
	{	NULL,	FRAME_STRINGS[8],	155.0,	408.0,	 1.0,	true }, // Save settings.cfg: SD/USB
	//TextBoxes for Video Tab (starts at textBox[4])
	{	NULL,	FRAME_STRINGS[13],	190.0,	128.0,	 1.0,	true }, // Show FPS: On/Off
	{	NULL,	FRAME_STRINGS[14],	130.0,	198.0,	 1.0,	true }, // ScreenMode: 4x3/16x9/Force16x9
	{	NULL,	FRAME_STRINGS[15],	190.0,	268.0,	 1.0,	true }, // CPU Framebuffer: On/Off
	{	NULL,	FRAME_STRINGS[16],	190.0,	338.0,	 1.0,	true }, // 2xSai: On/Off
	{	NULL,	FRAME_STRINGS[17],	190.0,	408.0,	 1.0,	true }, // FBTex: On/Off
	//TextBoxes for Input Tab (starts at textBox[9])
	{	NULL,	FRAME_STRINGS[26],	155.0,	338.0,	 1.0,	true }, // 2xSai: On/Off
	{	NULL,	FRAME_STRINGS[27],	155.0,	408.0,	 1.0,	true }, // 2xSai: On/Off
	//TextBoxes for Audio Tab (starts at textBox[11])
	{	NULL,	FRAME_STRINGS[29],	210.0,	128.0,	 1.0,	true }, // Disable Audio: Yes/No
	//TextBoxes for Saves Tab (starts at textBox[12])
	{	NULL,	FRAME_STRINGS[32],	200.0,	128.0,	 1.0,	true }, // Auto Save Native Save: Yes/No
};
...
void SettingsFrame::activateSubmenu(int submenu)
{
	...
	{						//Config buttons: set visible; set selected
		...
		case SUBMENU_INPUT:
			...
			if (loadButtonSlot == LOADBUTTON_DEFAULT)	strcpy(FRAME_STRINGS[32], "Default");
			else										sprintf(FRAME_STRINGS[32], "Slot %d", loadButtonSlot+1);
			for (int i = 27; i < 33; i++)
			{
				FRAME_BUTTONS[i].button->setVisible(true);
				FRAME_BUTTONS[i].button->setActive(true);
		...
		case SUBMENU_SAVES:
			...
			for (int i = 35; i < NUM_FRAME_BUTTONS; i++)
			{
				FRAME_BUTTONS[i].button->setVisible(true);
				FRAME_BUTTONS[i].button->setActive(true);
			}
...
void Func_ToggleButtonLoad()
{
	...
	if (loadButtonSlot == LOADBUTTON_DEFAULT)
		strcpy(FRAME_STRINGS[28], "Default");
	else
		sprintf(FRAME_STRINGS[28], "Slot %d", loadButtonSlot+1);
}
