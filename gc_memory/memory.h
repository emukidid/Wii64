...
#define read_word_in_memory(address)   rwmem[((u32)(address))>>16][MEM_READ_WORD](address)
#define read_byte_in_memory(address)   rwmem[((u32)(address))>>16][MEM_READ_BYTE](address)
#define read_hword_in_memory(address)  rwmem[((u32)(address))>>16][MEM_READ_HALF](address)
#define read_dword_in_memory(address)  rwmem[((u32)(address))>>16][MEM_READ_LONG](address)
#define write_word_in_memory(address)  rwmem[((u32)(address))>>16][MEM_WRITE_WORD](address)
#define write_byte_in_memory(address)  rwmem[((u32)(address))>>16][MEM_WRITE_BYTE](address)
#define write_hword_in_memory(address) rwmem[((u32)(address))>>16][MEM_WRITE_HALF](address)
#define write_dword_in_memory(address) rwmem[((u32)(address))>>16][MEM_WRITE_LONG](address)
...
extern unsigned long long int (**rwmem[0x10000])(unsigned long);
