...
// TLB
#define TLBCACHE_LO		(ROMCACHE_HI)
#define TLBCACHE_SIZE	(32*KB)
#define TLBCACHE_HI		(TLBCACHE_LO+TLBCACHE_SIZE)

// 128KB for recomp-cache-heap swap buffer
#define RECOMP_CACHE_HEAP_SCRATCH_LO (TLBCACHE_HI)
#define RECOMP_CACHE_HEAP_SCRATCH_SIZE (128*KB)
#define RECOMP_CACHE_HEAP_SCRATCH_HI (RECOMP_CACHE_HEAP_SCRATCH_LO + RECOMP_CACHE_HEAP_SCRATCH_SIZE)

#if (RECOMP_CACHE_HEAP_SCRATCH_HI - ARAM_VM_BASE) > (ARAM_SIZE)
#error "Too much ARAM used!"
#endif
